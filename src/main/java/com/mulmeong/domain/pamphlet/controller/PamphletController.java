...
@RestController
@RequestMapping("/api/v1/pamphlets")
...
public class PamphletController {
    ...
    public PamphletCreateResponse create(@AuthenticationPrincipal Long userId, @RequestBody PamphletCreateRequest request) {
        return service.create(userId, request);
    }

    @GetMapping
    public PamphletListResponse list(@AuthenticationPrincipal Long userId, @RequestParam(defaultValue = "0") int page, @RequestParam(defaultValue = "12") int size) {
    ...
    public void delete(@AuthenticationPrincipal Long userId, @PathVariable Long pamphletId) {
        service.delete(userId, pamphletId);
    }
}
