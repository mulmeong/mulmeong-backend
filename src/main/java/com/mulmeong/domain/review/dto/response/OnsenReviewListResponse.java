...
public record OnsenReviewListResponse(List<Item> content, int page, int size, long totalElements, int totalPages,
                                      boolean last) {
    public record Item(Long reviewId, Author author, short rating, LocalDate visitedAt, boolean isRevisit,
                       Spec spec, String body, List<String> images, boolean isMine, boolean isEdited,
